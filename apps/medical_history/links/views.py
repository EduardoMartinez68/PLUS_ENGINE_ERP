...
def view_load_theeth(request, customer_id):
    data = {"customer_id": customer_id} 
    return render(request, 'load_teeth.html', data)  

def get_form_theeth(request, customer_id):
    result = get_information_of_the_medical_history_for_customer_id(request.user, customer_id)
    if result["success"]:
        html = render_to_string("theeth.html", {"patient": result["answer"]}, request=request)
...
#-------------this is for update the container that exist in the home of the app-----------------------
...
#-----------view form medical history in the UI of the medical history----------------
def form_history_medical(request, customer_id):
    result = {"customer_id": customer_id} 
    return render(request, 'viewLoad/form_medical_history.html', result) 
